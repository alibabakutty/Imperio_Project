      ...
      <div className='w-[550px] h-[15vh] border border-gray-500 ml-[750px]'>
        ...
        <form >
          ...
          <div className='input-ldgr mt-3'>
            ...
            : <input
               ...
               onChange={(e) => setLedgerCode(e.target.value)}
                ...
                ref={(input) => { inputRefs.current.ledgerCode = input; }}
          ...
          <div className='mt-[445px]'>
            <input type="button" id='acceptButton' onKeyDown={(e) => {if(e.key === 'Backspace'){e.preventDefault(); if(inputRefs.current.ledgerName && inputRefs.current.ledgerName.focus){inputRefs.current.ledgerName.focus(); }} }} value={"A: Accept"} ref={(button) => {acceptButtonRef.current = button;}} onClick={(e) => saveLedgerMaster(e)} className='text-sm px-8 py-1 mt-3 border bg-slate-600 hover:bg-slate-800 ml-[100px]' />
          </div>

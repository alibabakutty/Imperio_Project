        ...
        <div className='w-[90%] flex h-screen'>
          ...
          <div className='w-[300px] h-96 border border-blue-400 text-sm bg-[#def1fc]'>
            ...
            <ul>
              ...
              <Link to={'/alter/voucherTypeAlter'} ref={voucherTypeRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Voucher Type Master</li>
              </Link>

              <Link to={'/alter/ledgerAlter'} ref={ledgerRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Ledger Master</li>
              </Link>

              <Link to={'/alter/regionAlter'} ref={regionRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Region Master</li>
              </Link>

              <Link to={'/alter/executiveAlter'} ref={executiveRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Executive Master</li>
              </Link>

              <Link to={'/alter/distributorAlter'} ref={distributorRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Distributor Master</li>
              </Link>
              
              <Link to={'/alter/productAlter'} ref={productRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Product Master</li>
              </Link>
              
              <Link to={'/alter/godownAlter'} ref={godownRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>

        ...
        <div className='w-[90%] flex h-screen'>
          ...
          <div className='w-[300px] h-96 border border-blue-400 text-sm bg-[#def1fc]'>
            ...
            <ul>
              ...
              <Link to={'/voucherTypeAlter/filter'} ref={voucherTypeRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Voucher Type Master</li>
              </Link>

              <Link to={'/ledgerAlter/filter'} ref={ledgerRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Ledger Master</li>
              </Link>

              <Link to={'/regionAlter/filter'} ref={regionRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Region Master</li>
              </Link>

              <Link to={'/executiveAlter/filter'} ref={executiveRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Executive Master</li>
              </Link>

              <Link to={'/distributorAlter/filter'} ref={distributorRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Distributor Master</li>
              </Link>
              
              <Link to={'/productAlter/filter'} ref={productRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>
                <li className='w-full pl-20'>Product Master</li>
              </Link>
              
              <Link to={'/godownAlter/filter'} ref={godownRef} className='block outline-none focus:bg-yellow-500 mb-[2px]'>

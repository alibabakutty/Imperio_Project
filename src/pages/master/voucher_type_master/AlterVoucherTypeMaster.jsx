...
const AlterVoucherTypeMaster = () => {
    ...
    useEffect(() => {
      ...
      if(showSubFormModal){
        ...
        const fetchVoucherTypeSuggestions = async () => {
          try{
            const response = await axios.get('http://localhost:9080/voucherTypeApi/allVoucherTypes');
    ...
    const handleSubFormSave = async () => {
      try {
        const response = await axios.put(`http://localhost:9080/voucherTypeMasterApi/alterVoucherTypeMaster/${voucherTypeName}`, voucher);
